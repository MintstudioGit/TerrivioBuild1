...
function IconNavigation({
  ...
  return (
    <div
      className="bg-[#000000] box-border content-stretch flex flex-col gap-2 h-full items-center justify-start overflow-clip p-4 relative rounded-none shrink-0 w-16 border-r border-neutral-800"
...
function DetailSidebar({
  ...
  return (
    <div
      className={`bg-[#000000] box-border content-stretch flex flex-col gap-4 h-full items-start justify-start overflow-visible p-4 relative shrink-0 transition-all duration-500 ${
        isCollapsed
